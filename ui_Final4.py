...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1442, 980)
        self.centralwidget = QWidget(MainWindow)
        self.centralwidget.setObjectName(u"centralwidget")
        self.widget = QWidget(self.centralwidget)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(10, 10, 1128, 955))
...
"}")
        icon6 = QIcon()
        icon6.addFile(u":/Icons/education (6).png", QSize(), QIcon.Normal, QIcon.Off)
        icon6.addFile(u":/Icons/education (3).png", QSize(), QIcon.Normal, QIcon.On)
        icon6.addFile(u":/Icons/education (3).png", QSize(), QIcon.Active, QIcon.On)
...
"}")
        icon7 = QIcon()
        icon7.addFile(u":/Icons/report (6).png", QSize(), QIcon.Normal, QIcon.Off)
        icon7.addFile(u":/Icons/report (3).png", QSize(), QIcon.Normal, QIcon.On)
        icon7.addFile(u":/Icons/report (3).png", QSize(), QIcon.Active, QIcon.On)
        self.reports_2.setIcon(icon7)
...
"border-radius: 15px;")
        ...
        icon8 = QIcon()
        icon8.addFile(u":/Icons/burger-bar (6).png", QSize(), QIcon.Normal, QIcon.Off)
        icon8.addFile(u":/Icons/burger-bar (3).png", QSize(), QIcon.Normal, QIcon.On)
...
"")
        icon9 = QIcon()
        icon9.addFile(u":/Icons/magnifying-glass (3).png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.main_sceen_widget.setMinimumSize(QSize(841, 870))
        self.main_sceen_widget.setMaximumSize(QSize(16777215, 870))
        font2 = QFont()
...
"border-radius: 15px;")
        ...
        self.stackedWidget.setGeometry(QRect(10, 10, 1051, 771))
        font3 = QFont()
...
"/*background-color: rgb(236, 236, 236);*/")
        ...
        self.frame.setGeometry(QRect(600, 370, 361, 261))
...
"color: white;")
        ...
        self.frame_2.setGeometry(QRect(350, 90, 301, 251))
...
"background-color: rgb(14, 13, 106);")
        ...
        self.label_12.setGeometry(QRect(110, 10, 141, 33))
        font5 = QFont()
...
"color: white;")
        ...
        self.label_14.setGeometry(QRect(10, 30, 81, 81))
        font6 = QFont()
        ...
        self.label_15.setGeometry(QRect(140, 50, 91, 71))
...
"background-color: #8ba9d0;")
        ...
        self.frame_5.setGeometry(QRect(690, 230, 261, 131))
        ...
        self.label_18.setGeometry(QRect(160, 10, 51, 33))
        ...
        self.label_20.setGeometry(QRect(140, 50, 91, 71))
...
"background-color: #8ba9d0;")
        ...
        self.frame_6.setGeometry(QRect(80, 360, 491, 281))
...
"color: white;")
        ...
        self.studentInfo_table.setGeometry(QRect(-10, 140, 941, 291))
...
"}")
        ...
        self.widget1 = QWidget(self.page_1)
        self.widget1.setObjectName(u"widget1")
        self.widget1.setGeometry(QRect(30, 80, 741, 51))
...
"}")
        icon10 = QIcon()
        icon10.addFile(u":/Icons/add-friend2.png", QSize(), QIcon.Normal, QIcon.Off)
        self.addStudent_button.setIcon(icon10)
...
"}")
        ...
        self.studentInfo_table_2.setHorizontalHeaderItem(0, __qtablewidgetitem16)
        __qtablewidgetitem17 = QTableWidgetItem()
        __qtablewidgetitem17.setFont(font8);
        self.studentInfo_table_2.setHorizontalHeaderItem(1, __qtablewidgetitem17)
        __qtablewidgetitem18 = QTableWidgetItem()
        self.studentInfo_table_2.setHorizontalHeaderItem(2, __qtablewidgetitem18)
        __qtablewidgetitem19 = QTableWidgetItem()
        self.studentInfo_table_2.setHorizontalHeaderItem(3, __qtablewidgetitem19)
        __qtablewidgetitem20 = QTableWidgetItem()
        self.studentInfo_table_2.setHorizontalHeaderItem(4, __qtablewidgetitem20)
        if (self.studentInfo_table_2.rowCount() < 6):
            self.studentInfo_table_2.setRowCount(6)
        __qtablewidgetitem21 = QTableWidgetItem()
        __qtablewidgetitem21.setTextAlignment(Qt.AlignCenter);
        self.studentInfo_table_2.setVerticalHeaderItem(0, __qtablewidgetitem21)
        __qtablewidgetitem22 = QTableWidgetItem()
        __qtablewidgetitem22.setTextAlignment(Qt.AlignCenter);
        self.studentInfo_table_2.setVerticalHeaderItem(1, __qtablewidgetitem22)
        __qtablewidgetitem23 = QTableWidgetItem()
        __qtablewidgetitem23.setTextAlignment(Qt.AlignCenter);
        self.studentInfo_table_2.setVerticalHeaderItem(2, __qtablewidgetitem23)
        __qtablewidgetitem24 = QTableWidgetItem()
        __qtablewidgetitem24.setTextAlignment(Qt.AlignCenter);
        self.studentInfo_table_2.setVerticalHeaderItem(3, __qtablewidgetitem24)
        __qtablewidgetitem25 = QTableWidgetItem()
        __qtablewidgetitem25.setTextAlignment(Qt.AlignCenter);
        self.studentInfo_table_2.setVerticalHeaderItem(4, __qtablewidgetitem25)
        __qtablewidgetitem26 = QTableWidgetItem()
        __qtablewidgetitem26.setTextAlignment(Qt.AlignCenter);
        self.studentInfo_table_2.setVerticalHeaderItem(5, __qtablewidgetitem26)
        self.studentInfo_table_2.setObjectName(u"studentInfo_table_2")
        self.studentInfo_table_2.setGeometry(QRect(200, 180, 551, 281))
...
"}")
        ...
        self.label_13.setGeometry(QRect(9, 9, 260, 33))
...
"padding-left: 15px;")
        ...
        self.addStudent_button_2.setGeometry(QRect(30, 60, 121, 35))
        ...
        font11.setBold(True)
        self.addStudent_button_2.setFont(font11)
...
"}")
        icon11 = QIcon()
        icon11.addFile(u":/Icons/ad-blocker (2).png", QSize(), QIcon.Normal, QIcon.Off)
        self.addStudent_button_2.setIcon(icon11)
        ...
        self.violence_reoprts_table.setHorizontalHeaderItem(0, __qtablewidgetitem27)
        __qtablewidgetitem28 = QTableWidgetItem()
        self.violence_reoprts_table.setHorizontalHeaderItem(1, __qtablewidgetitem28)
        if (self.violence_reoprts_table.rowCount() < 7):
            self.violence_reoprts_table.setRowCount(7)
        __qtablewidgetitem29 = QTableWidgetItem()
        self.violence_reoprts_table.setVerticalHeaderItem(0, __qtablewidgetitem29)
        __qtablewidgetitem30 = QTableWidgetItem()
        self.violence_reoprts_table.setVerticalHeaderItem(1, __qtablewidgetitem30)
        __qtablewidgetitem31 = QTableWidgetItem()
        self.violence_reoprts_table.setVerticalHeaderItem(2, __qtablewidgetitem31)
        __qtablewidgetitem32 = QTableWidgetItem()
        self.violence_reoprts_table.setVerticalHeaderItem(3, __qtablewidgetitem32)
        __qtablewidgetitem33 = QTableWidgetItem()
        self.violence_reoprts_table.setVerticalHeaderItem(4, __qtablewidgetitem33)
        __qtablewidgetitem34 = QTableWidgetItem()
        self.violence_reoprts_table.setVerticalHeaderItem(5, __qtablewidgetitem34)
        __qtablewidgetitem35 = QTableWidgetItem()
        self.violence_reoprts_table.setVerticalHeaderItem(6, __qtablewidgetitem35)
        self.violence_reoprts_table.setObjectName(u"violence_reoprts_table")
        self.violence_reoprts_table.setGeometry(QRect(9, 130, 881, 411))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        ___qtablewidgetitem16 = self.studentInfo_table_2.horizontalHeaderItem(0)
        ___qtablewidgetitem16.setText(QCoreApplication.translate("MainWindow", u"Student ID", None));
        ___qtablewidgetitem17 = self.studentInfo_table_2.horizontalHeaderItem(1)
        ___qtablewidgetitem17.setText(QCoreApplication.translate("MainWindow", u"Name", None));
        ___qtablewidgetitem18 = self.studentInfo_table_2.horizontalHeaderItem(2)
        ___qtablewidgetitem18.setText(QCoreApplication.translate("MainWindow", u"Date", None));
        ___qtablewidgetitem19 = self.studentInfo_table_2.horizontalHeaderItem(3)
        ___qtablewidgetitem19.setText(QCoreApplication.translate("MainWindow", u"Class", None));
        ___qtablewidgetitem20 = self.studentInfo_table_2.horizontalHeaderItem(4)
        ___qtablewidgetitem20.setText(QCoreApplication.translate("MainWindow", u"Status", None));
        ___qtablewidgetitem21 = self.studentInfo_table_2.verticalHeaderItem(0)
        ___qtablewidgetitem21.setText(QCoreApplication.translate("MainWindow", u"1", None));
        ___qtablewidgetitem22 = self.studentInfo_table_2.verticalHeaderItem(1)
        ___qtablewidgetitem22.setText(QCoreApplication.translate("MainWindow", u"2", None));
        ___qtablewidgetitem23 = self.studentInfo_table_2.verticalHeaderItem(2)
        ___qtablewidgetitem23.setText(QCoreApplication.translate("MainWindow", u"3", None));
        ___qtablewidgetitem24 = self.studentInfo_table_2.verticalHeaderItem(3)
        ___qtablewidgetitem24.setText(QCoreApplication.translate("MainWindow", u"4", None));
        ___qtablewidgetitem25 = self.studentInfo_table_2.verticalHeaderItem(4)
        ___qtablewidgetitem25.setText(QCoreApplication.translate("MainWindow", u"5", None));
        ___qtablewidgetitem26 = self.studentInfo_table_2.verticalHeaderItem(5)
        ...
        ___qtablewidgetitem27 = self.violence_reoprts_table.horizontalHeaderItem(0)
        ___qtablewidgetitem27.setText(QCoreApplication.translate("MainWindow", u"ID", None));
        ___qtablewidgetitem28 = self.violence_reoprts_table.horizontalHeaderItem(1)
        ___qtablewidgetitem28.setText(QCoreApplication.translate("MainWindow", u"Date", None));
        ___qtablewidgetitem29 = self.violence_reoprts_table.verticalHeaderItem(0)
        ___qtablewidgetitem29.setText(QCoreApplication.translate("MainWindow", u"New Row", None));
        ___qtablewidgetitem30 = self.violence_reoprts_table.verticalHeaderItem(1)
        ___qtablewidgetitem30.setText(QCoreApplication.translate("MainWindow", u"New Row", None));
        ___qtablewidgetitem31 = self.violence_reoprts_table.verticalHeaderItem(2)
        ___qtablewidgetitem31.setText(QCoreApplication.translate("MainWindow", u"New Row", None));
        ___qtablewidgetitem32 = self.violence_reoprts_table.verticalHeaderItem(3)
        ___qtablewidgetitem32.setText(QCoreApplication.translate("MainWindow", u"New Row", None));
        ___qtablewidgetitem33 = self.violence_reoprts_table.verticalHeaderItem(4)
        ___qtablewidgetitem33.setText(QCoreApplication.translate("MainWindow", u"New Row", None));
        ___qtablewidgetitem34 = self.violence_reoprts_table.verticalHeaderItem(5)
        ___qtablewidgetitem34.setText(QCoreApplication.translate("MainWindow", u"New Row", None));
        ___qtablewidgetitem35 = self.violence_reoprts_table.verticalHeaderItem(6)
