...
################################################################################
## Form generated from reading UI file 'indexLatestJune.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget.setGeometry(QRect(13, 11, 1251, 862))
...
"background-color: rgb(255, 255, 255);")
        ...
        self.layoutWidget1.setGeometry(QRect(10, 90, 921, 261))
...
"background-color: #8ba9d0;")
        ...
        self.frame_5 = QFrame(self.layoutWidget1)
...
"background-color: #8ba9d0;")
        ...
        self.layoutWidget2 = QWidget(self.page_0)
        self.layoutWidget2.setObjectName(u"layoutWidget2")
        self.layoutWidget2.setGeometry(QRect(10, 380, 921, 311))
...
"}")
        ...
        self.layoutWidget3 = QWidget(self.page_1)
        self.layoutWidget3.setObjectName(u"layoutWidget3")
        self.layoutWidget3.setGeometry(QRect(30, 90, 741, 51))
        self.horizontalLayout_5 = QHBoxLayout(self.layoutWidget3)
        self.horizontalLayout_5.setObjectName(u"horizontalLayout_5")
        self.horizontalLayout_5.setContentsMargins(0, 0, 0, 0)
        self.addStudent_button = QPushButton(self.layoutWidget3)
...
"}")
        ...
        self.select_gender = QComboBox(self.layoutWidget3)
...
"}")
        ...
        self.select_class = QComboBox(self.layoutWidget3)
...
"}")
        ...
        self.search_student = QLineEdit(self.layoutWidget3)
...
"}")
        ...
        self.studentInfo_table_2.setGeometry(QRect(200, 180, 561, 211))
...
"}")
        ...
        self.studentInfo_table_2.horizontalHeader().setStretchLastSection(True)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        ___qtablewidgetitem27.setText(QCoreApplication.translate("MainWindow", u"Potential", None));
