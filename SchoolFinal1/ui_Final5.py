...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1610, 980)
        self.centralwidget = QWidget(MainWindow)
        self.centralwidget.setObjectName(u"centralwidget")
        self.layoutWidget = QWidget(self.centralwidget)
        self.layoutWidget.setObjectName(u"layoutWidget")
        self.layoutWidget.setGeometry(QRect(10, 10, 1128, 984))
...
"}")
        ...
        icon.addFile(u":/Icons/home (3).png", QSize(), QIcon.Active, QIcon.On)
...
"}")
        ...
        icon1.addFile(u":/Icons/education (3).png", QSize(), QIcon.Active, QIcon.On)
...
"}")
        ...
        icon5.addFile(u":/Icons/report (3).png", QSize(), QIcon.Active, QIcon.On)
        self.reports_2.setIcon(icon5)
...
"}")
        ...
        icon6.addFile(u":/Icons/home (3).png", QSize(), QIcon.Normal, QIcon.On)
        self.home_1.setIcon(icon6)
...
"")
        ...
        self.main_sceen_widget = QWidget(self.layoutWidget)
...
"border-radius: 15px;")
        ...
        self.stackedWidget.setGeometry(QRect(0, 0, 901, 761))
        font3 = QFont()
...
"}")
        ...
        self.layoutWidget1.setGeometry(QRect(30, 80, 741, 51))
        self.horizontalLayout_5 = QHBoxLayout(self.layoutWidget1)
        self.horizontalLayout_5.setObjectName(u"horizontalLayout_5")
        self.horizontalLayout_5.setContentsMargins(0, 0, 0, 0)
        self.addStudent_button = QPushButton(self.layoutWidget1)
...
"}")
        ...
        self.select_gender = QComboBox(self.layoutWidget1)
...
"}")
        ...
        self.select_class = QComboBox(self.layoutWidget1)
...
"}")
        ...
        self.search_student = QLineEdit(self.layoutWidget1)
...
"}")
        ...
        self.label_28.setGeometry(QRect(340, 230, 111, 81))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_28.setText(QCoreApplication.translate("MainWindow", u"Attendance monitoring", None))
