...
"")
        ...
        self.main_sceen_widget = QWidget(self.centralwidget)
...
"border-radius: 15px;")
        ...
        self.stackedWidget.setGeometry(QRect(10, 10, 1121, 771))
        font3 = QFont()
...
"}")
        ...
        self.widget.setGeometry(QRect(30, 80, 741, 51))
        self.horizontalLayout_5 = QHBoxLayout(self.widget)
        self.horizontalLayout_5.setObjectName(u"horizontalLayout_5")
        self.horizontalLayout_5.setContentsMargins(0, 0, 0, 0)
        self.addStudent_button = QPushButton(self.widget)
...
"}")
        ...
        self.select_gender = QComboBox(self.widget)
...
"}")
        ...
        self.select_class = QComboBox(self.widget)
...
"}")
        ...
        self.search_student = QLineEdit(self.widget)
...
"padding-left: 15px;")
        ...
        font10.setBold(True)
        self.addStudent_button_2.setFont(font10)
...
"}")
        ...
        self.violence_reoprts_table.setHorizontalHeaderItem(0, __qtablewidgetitem16)
        __qtablewidgetitem17 = QTableWidgetItem()
        self.violence_reoprts_table.setHorizontalHeaderItem(1, __qtablewidgetitem17)
        if (self.violence_reoprts_table.rowCount() < 7):
            self.violence_reoprts_table.setRowCount(7)
        __qtablewidgetitem18 = QTableWidgetItem()
        self.violence_reoprts_table.setVerticalHeaderItem(0, __qtablewidgetitem18)
        __qtablewidgetitem19 = QTableWidgetItem()
        self.violence_reoprts_table.setVerticalHeaderItem(1, __qtablewidgetitem19)
        __qtablewidgetitem20 = QTableWidgetItem()
        self.violence_reoprts_table.setVerticalHeaderItem(2, __qtablewidgetitem20)
        __qtablewidgetitem21 = QTableWidgetItem()
        self.violence_reoprts_table.setVerticalHeaderItem(3, __qtablewidgetitem21)
        __qtablewidgetitem22 = QTableWidgetItem()
        self.violence_reoprts_table.setVerticalHeaderItem(4, __qtablewidgetitem22)
        __qtablewidgetitem23 = QTableWidgetItem()
        self.violence_reoprts_table.setVerticalHeaderItem(5, __qtablewidgetitem23)
        __qtablewidgetitem24 = QTableWidgetItem()
        self.violence_reoprts_table.setVerticalHeaderItem(6, __qtablewidgetitem24)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        ___qtablewidgetitem16 = self.violence_reoprts_table.horizontalHeaderItem(0)
        ___qtablewidgetitem16.setText(QCoreApplication.translate("MainWindow", u"ID", None));
        ___qtablewidgetitem17 = self.violence_reoprts_table.horizontalHeaderItem(1)
        ___qtablewidgetitem17.setText(QCoreApplication.translate("MainWindow", u"Date", None));
        ___qtablewidgetitem18 = self.violence_reoprts_table.verticalHeaderItem(0)
        ___qtablewidgetitem18.setText(QCoreApplication.translate("MainWindow", u"New Row", None));
        ___qtablewidgetitem19 = self.violence_reoprts_table.verticalHeaderItem(1)
        ___qtablewidgetitem19.setText(QCoreApplication.translate("MainWindow", u"New Row", None));
        ___qtablewidgetitem20 = self.violence_reoprts_table.verticalHeaderItem(2)
        ___qtablewidgetitem20.setText(QCoreApplication.translate("MainWindow", u"New Row", None));
        ___qtablewidgetitem21 = self.violence_reoprts_table.verticalHeaderItem(3)
        ___qtablewidgetitem21.setText(QCoreApplication.translate("MainWindow", u"New Row", None));
        ___qtablewidgetitem22 = self.violence_reoprts_table.verticalHeaderItem(4)
        ___qtablewidgetitem22.setText(QCoreApplication.translate("MainWindow", u"New Row", None));
        ___qtablewidgetitem23 = self.violence_reoprts_table.verticalHeaderItem(5)
        ___qtablewidgetitem23.setText(QCoreApplication.translate("MainWindow", u"New Row", None));
        ___qtablewidgetitem24 = self.violence_reoprts_table.verticalHeaderItem(6)
