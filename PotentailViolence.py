...
def FaceYacta(path):
    ...
    # Convert the modified array of strings to integers
    array_int = [int(s) for s in names_list_capturing]
    return SQLServerDoWork.findStudentsById(array_int)


print(FaceYacta(f'Violence_Incidences/2024-04-16 12_45_09.mp4'))